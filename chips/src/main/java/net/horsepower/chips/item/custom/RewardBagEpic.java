...
public class RewardBagEpic extends Item {
    public RewardBagEpic(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        int count = rds.nextInt(CustomItemLists.epicCount) +1;

        //get the list
        List<Integer> list = CustomItemLists.epicList;
