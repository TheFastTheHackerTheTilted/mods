...
public class RewardBagLegendary extends Item {
    public RewardBagLegendary(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        int count = rds.nextInt(CustomItemLists.legendaryCount) +1;

        //get the list
        List<Integer> list = CustomItemLists.legendaryList;
