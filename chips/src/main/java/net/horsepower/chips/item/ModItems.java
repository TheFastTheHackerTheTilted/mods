...
import net.horsepower.chips.item.custom.DebugBag;
import net.horsepower.chips.item.custom.RewardBagCommon;
import net.horsepower.chips.item.custom.idGetter;
...
public class ModItems {
    ...
    public static final Item BAG_RARE = registerModItem("bag_rare",
            new Item(new Item.Settings()), ModItemGroup.CHIPS);
